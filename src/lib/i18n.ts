...
const EN: Dictionary = {
  ...
  "Hoje":"Today","Ontem":"Yesterday","Esta semana":"This week","Mais antigas":"Older","Mais recentes":"Newest","Mais antigas":"Oldest","Remetente":"Sender","Assunto":"Subject","Status":"Status",
  ...
  "E-mails":"Emails","Telefones":"Phones","Endereços":"Addresses","Datas importantes":"Important dates","Grupos / listas":"Groups / lists","Observações":"Notes","Origem":"Source","Local":"Local","compartilhado":"shared","compartilhada":"shared",
  ...
  "Todas":"All","ABERTAS":"OPEN","CONCLUÍDAS":"COMPLETED","Atrasadas":"Overdue","Próximas":"Upcoming","Meu dia":"My day","Lista":"List","Prioridade":"Priority","Baixa":"Low","Normal":"Normal","Alta":"High","Vencimento":"Due date",
...
const ES: Dictionary = {
  ...
  "Todas":"Todas","ABERTAS":"ABIERTAS","CONCLUÍDAS":"COMPLETADAS","Atrasadas":"Atrasadas","Próximas":"Próximas","Meu dia":"Mi día","Lista":"Lista","Prioridade":"Prioridad","Baixa":"Baja","Normal":"Normal","Alta":"Alta","Vencimento":"Vencimiento",
